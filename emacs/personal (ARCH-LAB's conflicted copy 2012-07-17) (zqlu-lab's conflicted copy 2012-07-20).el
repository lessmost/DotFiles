...
(defun tabbar-config ()
  ...
  (global-set-key (kbd "C-c <C-down>") 'tabbar-forward-tab)
  (global-set-key (kbd "C-c <C-up>") 'tabbar-backward-tab)
  (global-set-key (kbd "C-c <C-right>") 'tabbar-forward-group)
  (global-set-key (kbd "C-c <C-left>") 'tabbar-backward-group)
...
(add-hook 'c-mode-hook
          (lambda ()
            (let ((filename (buffer-file-name)))
              ...
              (when (and filename
                         (string-match (expand-file-name "~/data/work/kernel")
                                       filename))
